...
eval("module.exports = __webpack_require__(/*! regenerator-runtime */ \"./node_modules/regenerator-runtime/runtime.js\");\n\n\n//# sourceURL=webpack://leaderboard/./node_modules/@babel/runtime/regenerator/index.js?");
...
"use strict";
eval("__webpack_require__.a(module, async (__webpack_handle_async_dependencies__) => {\n__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"./node_modules/@babel/runtime/regenerator/index.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _styles_style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./styles/style.scss */ \"./src/styles/style.scss\");\n\n\n\nvar API = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/hhuU7Jwb1hkX96Lmktcc/scores/';\nvar request = new XMLHttpRequest(); // The request type\n\nvar addButton = document.querySelector('.add-list'); // Submit the form and add a score to the score list\n\nvar scoresContainer = document.querySelector('.scores-container'); // Score list container\n\nvar displayTheUsersScore = function displayTheUsersScore(user) {\n  // for each score list we need a li and some spans to get the score and the name\n  user.forEach(function (score) {\n    var scoreList = document.createElement('li');\n    scoreList.classList.add('scores', 'flex', 'flex-jc-sb', 'flex-ai-c');\n    scoreList.innerHTML = \"<span class=\\\"score-name\\\">\".concat(score.user, \"</span> <span class=\\\"score-score\\\">\").concat(score.score, \"</span>\"); // Then we add the user's score to the score list\n\n    scoresContainer.appendChild(scoreList);\n  });\n};\n\nvar thePromise = function thePromise(url) {\n  return new Promise(function (resolve) {\n    request.open('GET', url);\n\n    request.onload = function () {\n      if (request.status === 200) {\n        // If the request is successful\n        resolve(request.response); // resolve the promise\n      } else {\n        // else if the request is not successful\n        resolve('error'); // return an error\n      }\n    };\n\n    request.send(); // Send the request\n  });\n};\n\nfunction asyncCall(_x) {\n  return _asyncCall.apply(this, arguments);\n}\n\nfunction _asyncCall() {\n  _asyncCall = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__[\"default\"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee2(url) {\n    var list;\n    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {\n      while (1) {\n        switch (_context2.prev = _context2.next) {\n          case 0:\n            thePromise(url);\n            _context2.t0 = JSON;\n            _context2.next = 4;\n            return thePromise(API);\n\n          case 4:\n            _context2.t1 = _context2.sent;\n            list = _context2.t0.parse.call(_context2.t0, _context2.t1);\n            return _context2.abrupt(\"return\", list.result);\n\n          case 7:\n          case \"end\":\n            return _context2.stop();\n        }\n      }\n    }, _callee2);\n  }));\n  return _asyncCall.apply(this, arguments);\n}\n\nasyncCall(API); // we ne only the last items from the API to be return\n\nvar removeListItems = function removeListItems() {\n  var ul = document.querySelector('.scores-container');\n  var child = ul.lastElementChild; // While our score container has a child\n\n  while (child) {\n    // We remove the child\n    ul.removeChild(child); // We get the next child, wich is added but not showed\n\n    child = ul.lastElementChild;\n  }\n}; // we need to refresh our App to get the last updates\n\n\nvar refreshBtn = document.querySelector('.refresh-button'); // By clicking on the refesh button, we print the score added to the leaderboard\n\nrefreshBtn.addEventListener('click', /*#__PURE__*/(0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__[\"default\"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee() {\n  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {\n    while (1) {\n      switch (_context.prev = _context.next) {\n        case 0:\n          // we first get items added\n          removeListItems(); // we then display it from the API\n\n          _context.t0 = displayTheUsersScore;\n          _context.next = 4;\n          return asyncCall(API);\n\n        case 4:\n          _context.t1 = _context.sent;\n          (0, _context.t0)(_context.t1);\n\n        case 6:\n        case \"end\":\n          return _context.stop();\n      }\n    }\n  }, _callee);\n})));\n\nvar sendTheData = function sendTheData(name, score) {\n  // we ne the data to be sended\n  var data = \"user=\".concat(name, \"&score=\").concat(score); // The data from the inputs\n  // We create the request by using the post method\n\n  request.open('POST', API, true); // We set the header to be json\n\n  request.setRequestHeader('Content-type', 'application/x-www-form-urlencoded'); // We send the data\n\n  request.send(data);\n}; // Here we check if the iputs are correct or not\n\n\nvar inputs = document.querySelectorAll('.name-score');\n\nvar _loop = function _loop(i) {\n  inputs[i].addEventListener('input', function () {\n    if (inputs[i].validity.valid) {\n      inputs[i].style.border = '3px solid green';\n    } else {\n      inputs[i].style.border = '3px solid red';\n    }\n  });\n};\n\nfor (var i = 0; i < inputs.length; i += 1) {\n  _loop(i);\n}\n\naddButton.addEventListener('click', function (event) {\n  event.preventDefault(); // Prevent the default action of the form\n\n  var isNumber = function isNumber(el) {\n    return /^[0-9]+$/.test(el) && !(/[a-z]/.test(el) || !/[A-Z]/.test(el));\n  }; // We get the data from the inputs\n\n\n  var name = document.querySelector('.name').value;\n  var score = document.querySelector('.score').value; // we check if the data entered is a number\n\n  if (!isNumber(score)) {\n    document.querySelector('.score').setCustomValidity('Hey dear, use numbers only please!');\n  }\n\n  if (name.length > 0 && score >= 0) {\n    // If the inputs are not empty\n    sendTheData(name, score); // We send the data\n  } else {\n    throw new Error('Check your input!');\n  } // We clear the inputs\n\n\n  document.querySelector('.name').value = '';\n  document.querySelector('.score').value = '';\n});\nvar show = await asyncCall(API);\ndisplayTheUsersScore(show);\n__webpack_handle_async_dependencies__();\n}, 1);\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ _asyncToGenerator)\n/* harmony export */ });\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {\n  try {\n    var info = gen[key](arg);\n    var value = info.value;\n  } catch (error) {\n    reject(error);\n    return;\n  }\n\n  if (info.done) {\n    resolve(value);\n  } else {\n    Promise.resolve(value).then(_next, _throw);\n  }\n}\n\nfunction _asyncToGenerator(fn) {\n  return function () {\n    var self = this,\n        args = arguments;\n    return new Promise(function (resolve, reject) {\n      var gen = fn.apply(self, args);\n\n      function _next(value) {\n        asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value);\n      }\n\n      function _throw(err) {\n        asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err);\n      }\n\n      _next(undefined);\n    });\n  };\n}\n\n//# sourceURL=webpack://leaderboard/./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js?");
